...
import static Bomberman.levels.NextLevel.wait;
...
public class SoundManager extends JFrame {
    ...
    public static Clip set_boom;
    public static Clip sound_leg;
    ...
    public SoundManager(String name, String sound) {
        ...
        try {
            ...
            if(sound.equals("set")) {
                set_boom = AudioSystem.getClip();
                set_boom.open(audioIn);
                set_boom.start();
            }
            if(sound.equals("leg")) {
                sound_leg = AudioSystem.getClip();
                sound_leg.open(audioIn);
                sound_leg.start();
            }
