...
import Bomberman.control.Blocked;
...
public class Bomb extends Entity {
    ...
    public static int numberBomb = 1;
    ...
    public static void activeBomb() throws IOException {
        if (swapActive == 1) {
    ...
    private static void checkActive() throws IOException {
        if (isBomb == 1) {
